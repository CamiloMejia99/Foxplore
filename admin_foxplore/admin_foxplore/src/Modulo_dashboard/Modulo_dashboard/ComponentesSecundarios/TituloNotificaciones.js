...
const TituloNotificaciones = ({titulo, textoResaltado = '', textoComplementario = '', botones = []}) => {
    ...
    return (
        ...
        >
            ...
            <Grid item container lg={6} sm={10} xs={8} sx={{justifyContent: 'flex-start'}}>
                <Grid
                    container
                    direction="row"
                ...
                >
                    ...
                    <Grid item container lg={12} sm={12} xs={12} sx={{justifyContent: 'flex-start'}}>
                        <Typography sx={{fontSize: sCell ? 28 : 40, fontWeight: 700, fontFamily: "Poppins"}}>
                            {titulo}
                        </Typography>
                    </Grid>
                    <Grid item container lg={12} sm={12} xs={12}
                          sx={{justifyContent: 'flex-start', marginTop: sCell ? -0.5 : 0}}>
            ...
            <Grid item container lg={6} sm={2} xs={4} sx={{justifyContent: 'flex-end'}}>
                <Grid
                    container
                    direction="row"
