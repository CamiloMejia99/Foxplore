...
const MenuLateral = ({
    ...
    return (
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Tarjeta_Usuario open={open} click={clickPerfil}/>

                        <MenuScroll open={open} menusOrdenados={menusOrdenados} masSM={masSM}/>

                        <Grid item container lg={12} sm={12} xs={12}
                              sx={{justifyContent: 'flex-start', marginTop: 4,}}>
                            <IconButton>
                                <LogoutOutlined sx={{width: 35, height: 35, fill: '#fff'}}/>
                            </IconButton>
            ...
            <MainDashboard open={open} secciones={secciones} masSM={masSM} seccionesID={seccionesID}/>
